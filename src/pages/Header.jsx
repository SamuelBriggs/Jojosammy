  ...
  return (
    ...
    custom3:-ml-12 custom3:h-32">
      <div className="flex-shrink-0 custom2:-ml-28 custom3:flex-col custom3:justify-center">
        <img className="custom3:justify-center custom3:ml-20 " style={{ width: "35px", height: "35px" }} src={Logo} alt="No image yet" />
        <div className="text-white text-2xl font-bold name custom:-mt-2 custom2:ml-12 custom3:mt-8">
          Samuel Alawode
        </div>
      </div>
    </div>
