  ...
  return (
    <div className="mt-32 ml-40">
      ...
      custom:-ml-40 custom:justify-center custom2:flex-col custom2:-ml-40 custom2:justify-center">
        ...
        <div className="ml-40 text-[#acaeb8] text-md w-6/12 custom:text-sm custom:mt-5 custom:w-9/12 custom:ml-20 custom2:text-md custom2:mt-5 custom2:w-10/12 custom2:ml-10">
