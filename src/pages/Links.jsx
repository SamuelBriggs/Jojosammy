  ...
  return (
    <div className='sm:justify-center custom:justify-center custom:w-full'>
        ...
        custom3:flex-row custom:justify-center">
          ...
          custom2:space-x-20 custom2:justify-center custom3:h-10 custom3:pt-2 custom3:border custom3:mr-7 
          custom3:ml-7 custom3:flex custom3:flex-row custom3:space-x-10 custom3:justify-center sm:flex 
